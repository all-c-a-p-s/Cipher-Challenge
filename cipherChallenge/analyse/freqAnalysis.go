...
func graph() {
	graph := chart.BarChart{
		...
		Bars: []chart.Value{
			{Value: 0.071077, Label: "A"},
			{Value: 0.018154, Label: "B"},
			{Value: 0.027692, Label: "C"},
			{Value: 0.048308, Label: "D"},
			{Value: 0.136923, Label: "E"},
			{Value: 0.022769, Label: "F"},
			{Value: 0.023077, Label: "G"},
			{Value: 0.045846, Label: "H"},
			{Value: 0.067385, Label: "I"},
			{Value: 0.001231, Label: "J"},
			{Value: 0.007077, Label: "K"},
			{Value: 0.026769, Label: "L"},
			{Value: 0.025538, Label: "M"},
			{Value: 0.081846, Label: "N"},
			{Value: 0.077846, Label: "O"},
			{Value: 0.017846, Label: "P"},
			{Value: 0.000615, Label: "Q"},
			{Value: 0.063077, Label: "R"},
			{Value: 0.065846, Label: "S"},
			{Value: 0.092308, Label: "T"},
			{Value: 0.030462, Label: "U"},
			{Value: 0.009846, Label: "V"},
			{Value: 0.019385, Label: "W"},
			{Value: 0.004000, Label: "X"},
			{Value: 0.014769, Label: "Y"},
			{Value: 0.000308, Label: "Z"},
